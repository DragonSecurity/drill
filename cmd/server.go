...
func init() {
	...
	viper.BindPFlag("server.tenancy.enable", serverCmd.Flags().Lookup("tenancy"))
	viper.BindPFlag("server.tenancy.storage", serverCmd.Flags().Lookup("tenancy-storage"))
	viper.BindPFlag("server.admin.enable", serverCmd.Flags().Lookup("admin"))
	viper.BindPFlag("server.admin.token", serverCmd.Flags().Lookup("admin-token"))
